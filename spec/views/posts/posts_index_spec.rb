    ...
    describe '#index' do
      before(:each) do
        ...
        @post3 = Post.create(title: 'Hi', text: 'How to stay healthy', author_id: @user.id, comments_counter: 0,
                             likes_counter: 0)
        @post2 = Post.create(title: 'Health recipe', text: 'Eat balance diet', author_id: @user.id, comments_counter: 0, likes_counter: 0)
        @post1 = Post.create(title: 'Energy', text: 'How to set the solar system', author_id: @user.id, comments_counter: 0, likes_counter: 0)
